  ...
  <a-layout id="components-layout-demo-custom-trigger">
    <a-layout-header style="background: #fff; padding: 0">
      <div class="header">
        ...
        <span class="header-title">双向优化职配系统</span>
        <div class="empty"></div>
    ...
    <a-layout>
      <a-layout-sider v-model="collapsed" collapsible >
        <a-menu style="overflow:auto; overflow-x: hidden;" v-model="selectedKeys" theme="light" mode="inline" @click="handleClick">
...
import logo from '/@/assets/images/logo-stencil.svg'

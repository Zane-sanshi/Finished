      ...
      <div class="thing-list">
        ...
        <a-spin :spinning="tData.loading" style="min-height: 200px;">
          <div class="things flex-view">
            <div class="sub-li" v-for="item in tData.pageData" :key="item.id" @click="handleDetail(item)">
        ...
        <div class="page-view" style="">
          <a-pagination v-model="tData.page" size="small" @change="changePage" :hideOnSinglePage="true"

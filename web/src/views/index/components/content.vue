  ...
  <div class="content">
    <div class="content-left">
      <div class="left-search-item">
        <img :src="Grid" class="icons-ouline">
        <h4>岗位分类</h4>
        <a-tree :tree-data="contentData.cData" :selected-keys="contentData.selectedKeys" @select="onSelectClass"
                style="min-height: 220px;">
        </a-tree>
      </div>
      <div class="left-search-item"><img :src="Cellular" class="icons-ouline"><h4>热门标签</h4>
    ...
    <div class="content-right">
      ...
      <a-spin :spinning="contentData.loading" style="min-height: 200px;">
        <div v-if="contentData.selectTabIndex <= 1" class="pc-thing-list flex-view">
          <div class="sub-li" v-for="item in contentData.pageData" :key="item.id" @click="handleDetail(item)">
        ...
        <div v-else class="pc-thing-list flex-view">
          <div class="sub-li" v-for="item in contentData.pageData" :key="item.id" @click="handleDetail(item)">
            <a class="job-info" target="_blank">
              ...
              <p class="job-text">
                <span style="display: inline-block; width: 200px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">{{ item.description }}</span>
              </p>
            </a>
          </div>
          <div v-if="contentData.pageData.length <= 0 && !contentData.loading" class="no-data" style="">暂无数据</div>
...
import Cellular from '/@/assets/images/cellular-outline.svg';
import Grid from '/@/assets/images/grid-outline.svg';
